export default class calculator {
     ...
     */
     users: Array<{name:string, email: string}> = [
        {name: "Kiss Béla", email:"kissBela@gmail.hu"},
        {name: "Kiss László", email:"kissLászló@gmail.hu"}
    ];
     ...
     */    
     products: Array<{name: string, price: number, stock: number, active?: boolean}> = [
        {name: "barack", price: 2000, stock: 100, active: true},
        {name: "sajt", price: 2000, stock: 100}
    ];
     ...
     */
     ...
     role: [number, string, boolean] = [6, "kecske", true];
